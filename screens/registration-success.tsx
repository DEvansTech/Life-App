      ...
      <View className="w-full h-full flex flex-col items-center justify-between">
        <View className="items-center mt-[200]">
          ...
          <Text
            ...
            className="mt-20 text-center text-cyan-800 text-[17px] font-semibold leading-snug"
          >
            Hello Jonathan Doe
          </Text>
          <Text
            style={{ fontFamily: "Poppins" }}
            className="mt-2 text-center text-zinc-600 text-base font-light leading-snug"
          >
